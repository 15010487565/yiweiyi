...
public class RawAdapter extends BaseQuickAdapter<ProximitySearchBean.DataBean.ListBean, BaseViewHolder> {

    private String keyword;

    public RawAdapter(int layoutResId, @Nullable List<ProximitySearchBean.DataBean.ListBean> data) {
