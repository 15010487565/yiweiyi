...
//    private int textColor = Color.BLACK;
    ...
    private  String yasnTitle;

    public String getYasnTitle() {
        return yasnTitle;
    }

    public void setYasnTitle(String yasnTitle) {
        this.yasnTitle = yasnTitle;
    }
...
//                    if (j==0){
//                        float  yasntitle = paint.measureText(getYasnTitle());
//                        canvas.drawText((String) ob, realDrawedWidth+ yasntitle, y, paint);
//                    }else {
